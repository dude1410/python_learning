...
for good, code in goods.items():
    ...
    for specific_good in items:
        total_count += specific_good.get("quantity")
        total_price += specific_good.get("quantity") * specific_good.get("price")
    print(good, '-', total_count, 'шт, стоимость', total_price, 'руб')
